...
document.addEventListener('DOMContentLoaded', function() {
    fetch('/txt-files/home.txt')
        .then(response => response.text())
        .then(data => {
            const contentDiv = document.getElementById('content-home');
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('/txt-files/owner_posted_problems.txt')
        .then(response => response.text())
        .then(data => {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    setTimeout(() => {
        logo.src = "/pictures/logos/Gritplan-4-5.png";
